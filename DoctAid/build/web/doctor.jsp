                ...
                <div class="row">
                    <div class="col-sm-3 sidebar">
                        <ul class="nav nav-sidebar">
                            ...
                            <li class="topic"><span class="upcoming"><b>Recent Appointment</b></span> 
                                <%
                    ...
                    <div class="col-sm-9 col-sm-offset-3 main">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="card">
                                    <div class="cardImage">
                                        <img src="media/calender.svg" width="220px">
                                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="card">
                                    <div class="cardImage">
                                        <img src="media/patient.svg" width="252px">
                                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="card">
                                    <div class="cardImage">
                                        <img src="media/profile.svg" width="195px"> 
                                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="panel">
                                    <div class="panel-heading">
                                        Last Login :  <%= session.getAttribute("LastAccess")%>
                                    </div>
                                </div>
                            </div>
                        </div>
