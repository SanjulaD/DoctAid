    ...
    public static int getProfileRating(int personId, int type) {
        ...
        switch (type) {
            ...
            case 4:
                ...
                if (labPerson.getFirstName() != null) {
                    count++;
                }
                if (labPerson.getLastName() != null) {
                    count++;
                }
                if (labPerson.getGender() != null) {
                    count++;
                }
                if (labPerson.getAddress() != null) {
                    count++;
                }
                if (labPerson.getContactNumber() != null) {
                    count++;
                }
                if (labPerson.getUserName() != null) {
                    count++;
                }
                if (labPerson.getStringDob() != null) {
                    count++;
                }
                res = (count / rate) * 100;
                break;
            case 5:
                ...
                if (receptionist.getContactNumber() != null) {
                    count++;
                }
                if (receptionist.getUserName() != null) {
                    count++;
                }
                if (receptionist.getStringDob() != null) {
                    count++;
                }
                res = (count / rate) * 100;
                break;
